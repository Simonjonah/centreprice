            ...
            <div class="col-12 col-sm-6">
              ...
              <div class="mt-4">
                <form action="{{ url('web/addtocart/'.$viewprodbyvendors->id) }}" method="get">
                  ...
                  <input type="text" name="productname" value="{{ $viewprodbyvendors->subcategory['subcategory'] }}" id="">
                  <input type="text" name="distributor_id" value="{{ Auth::user()->user_id }}" id="">
                  <input type="text" name="subvendor_commission" value="{{ $viewprodbyvendors->subvendor_commission }}" id="">
                  ...
                  <input type="text" name="distributor_email" value="{{ Auth::user()->distributor_email }}" id="">
                  <input type="text" name="vendor_email" value="{{ Auth::user()->subvendor_email }}" id="">
