  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h4 class="m-0 text-dark"><a href="{{ Auth::user()->referral_link }}" target="_blank" rel="noopener noreferrer">{{ Auth::user()->referral_link }}</a></h4>
          </div><!-- /.col -->
          <div class="col-sm-6">
                  ...
                  <div class="card-body">
                    ...
                    <div class="direct-chat-messages">
                      ...
                      <div class="direct-chat-msg">
                        ...
                        <!-- /.direct-chat-img -->
                        <div class="direct-chat-text">
                          Working withLTE on a great new app! Wanna join?
                        </div>
                        <!-- /.direct-chat-text -->
                      </div>
                      <!-- /.direct-chat-msg -->
