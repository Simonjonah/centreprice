        ...
        <div class="card-body">
          <div class="row">
            <div class="col-12 col-sm-6">
              <h3 class="d-inline-block d-sm-none">{{ $view_myprodocts->subcategory['subcategory'] }}</h3>
              <div class="col-12">
                <img style="height: 600px" src="{{ asset('/public/../'.$view_myprodocts->images1)}}" class="product-image" alt="Product Image">
              </div>
              <div class="col-12 product-image-thumbs">
                <div class="product-image-thumb active"><img src="{{ asset('/public/../'.$view_myprodocts->images1)}}" alt="Product Image"></div>
                <div class="product-image-thumb" ><img src="{{ asset('/public/../'.$view_myprodocts->images2)}}" alt="Product Image"></div>
                <div class="product-image-thumb" ><img src="{{ asset('/public/../'.$view_myprodocts->images3)}}" alt="Product Image"></div>
                <div class="product-image-thumb" ><img src="{{ asset('/public/../'.$view_myprodocts->images4)}}" alt="Product Image"></div>
                <div class="product-image-thumb" ><img src="{{ asset('/public/../'.$view_myprodocts->images5)}}" alt="Product Image"></div>
              </div>
            </div>
            <div class="col-12 col-sm-6">
              <h3 class="my-3">{{ $view_myprodocts->subcategory['subcategory'] }}</h3>
              <p>{!! $view_myprodocts->subcategory['body'] !!}</p>
              ...
              <div class="mt-4">
                {{-- <form action="{{ url('web/addtocart/'.$view_myprodocts->id) }}" method="get"> --}}
                  @csrf
          ...
          <div class="row mt-4">
            ...
            <div class="tab-content p-3" id="nav-tabContent">
              <div class="tab-pane fade show active" id="product-desc" role="tabpanel" aria-labelledby="product-desc-tab"> {!! $view_myprodocts->subcategory['body'] !!}</div>
