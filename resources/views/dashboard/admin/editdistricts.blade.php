  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Edit Senatarial Districts</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Edit Senatarial Districts</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{ url('admin/updateedistricts/'.$edit_dists->id) }}" method="post" enctype="multipart/form-data">
                  @csrf
                  @method('PUT')
                ...
                <div class="form-group">
                  ...
                  <select name="state" class="form-control select2" style="width: 100%;">
                    <option value="{{ $edit_dists->state }}">{{ $edit_dists->state }}</option>
                ...
                <div class="form-group">
                  ...
                  <select name="lga" class="form-control select2" style="width: 100%;">
                    <option value="{{ $edit_dists->lga }}">{{ $edit_dists->lga }}</option>
                ...
                <div class="form-group">
                    ...
                    value="{{ $edit_dists->districts }}" class="form-control" id="" placeholder="Enter Senatarial Districts">
                </div>
                @error('districts')
                    <span class="text-danger">{{ $message }}</span>
                @enderror
