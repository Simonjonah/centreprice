        ...
        <div class="col-12 col-sm-6 col-md-3">
          <div class="info-box mb-3">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number">{{ $countavailableproduct }}</span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-12 col-sm-6 col-md-3">
          <div class="info-box mb-3">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number">{{ $unavailbleproduct }}</span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
      ...
      <div class="row">
        ...
        <div class="col-12 col-sm-6 col-md-3">
          <div class="info-box mb-3">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Unregistered Distributor</span>
              <span class="info-box-number">{{ $countundistributor }}</span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-12 col-sm-6 col-md-3">
          <div class="info-box mb-3">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Registered Distributors</span>
              <span class="info-box-number">{{ $countsucessdistributor }}</span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <!-- /.col -->
         ...
         <div class="col-12 col-sm-6 col-md-3">
          <div class="info-box mb-3">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Unregistered Vendors</span>
              <span class="info-box-number">{{ $countundvendors }}</span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <!-- /.col -->
         ...
         <div class="col-12 col-sm-6 col-md-3">
          <div class="info-box mb-3">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Registered Vendors</span>
              <span class="info-box-number">{{ $countsuccessdvendors }}</span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
...
@elseif (Auth::guard('admin')->user()->status == 'approved' && Auth::guard('admin')->user()->role == '1')
...
<!-- /.col -->
      ...
      <div class="col-12 col-sm-6 col-md-3">
        <div class="info-box mb-3">
          <span class="info-box-icon bg-dark elevation-1"><i class="fas fa-comment"></i></span>
          <div class="info-box-content">
    ...
    <div class="row">
      ...
      <div class="col-md-4">
        ...
        <!-- /.card -->
         ...
         <div class="card">
          <div class="card-header">
            <h3 class="card-title">Recently Withdrawals</h3>
          ...
          <!-- /.card-body -->
          <div class="card-footer text-center">
            <a href="{{ url('admin/viewallwithdrawal') }}" class="uppercase">View All Withdrawal</a>
          </div>
          <!-- /.card-footer -->
        </div>
        <!-- /.card -->
