        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{ url('admin/updatedistributor/'.$edit_distributor->ref_no2) }}" method="post" enctype="multipart/form-data">
                  @csrf
                  @method('PUT')
                  ...
                  <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            value="{{ $edit_distributor->fname }}" class="form-control"  placeholder="first name">
                        </div>
                        @error('fname')
                        ...
                        <div class="form-group">
                            ...
                            value="{{ $edit_distributor->lname }}" class="form-control"  placeholder="Last name">
                        </div>
                        @error('lname')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                        ...
                        <div class="form-group">
                            ...
                            value="{{ $edit_distributor->email }}" class="form-control"  placeholder="email">
                        </div>
                        @error('email')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                        ...
                        <div class="form-group">
                            ...
                            value="{{ $edit_distributor->phone }}" class="form-control"  placeholder="phone">
                        </div>
                        @error('phone')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="ngstate_id" class="form-control select2" style="width: 100%;">
                              <option value="{{ $edit_distributor->ngstate['id'] }}">{{ $edit_distributor->ngstate['state'] }}</option>
                          ...
                          <div class="form-group">
                            ...
                            <select name="subscription_fee" class="form-control select2" style="width: 100%;">
                              <option value="{{ $edit_distributor->subscription_fee }}">{{ $edit_distributor->subscription_fee }}</option>
                            </select>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            value="{{ $edit_distributor->Lga->district['districts'] }}" class="form-control" id="" placeholder="districts">
                        </div>
                        @error('districts')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                        ...
                        <div class="form-group">
                            ...
                            <select name="lga_id" class="form-control select2" style="width: 100%;">
                              <option value="{{ $edit_distributor->Lga['id'] }}">{{ $edit_distributor->Lga['lga'] }}</option>
                    ...
                    <div class="form-group">
                        <td><img style="width: auto; height: 30px;" src="{{ URL::asset("/public/../$edit_distributor->images")}}" alt=""></td>
