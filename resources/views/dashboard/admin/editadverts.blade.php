        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{ url('admin/updateadverts/'.$edit_advert->ref_no) }}" method="post" enctype="multipart/form-data">
                  @csrf
                  @method('PUT')
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <label>Company Name</label>
                          ...
                          value="{{ $edit_advert->company_name }}" class="form-control" id="" placeholder="Company Name">
                      </div>
                      @error('company_name')
                      ...
                      <div class="form-group">
                        ...
                        value="{{ $edit_advert->title }}" class="form-control" id="" placeholder="Title">
                    </div>
                    @error('title')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                     ...
                     <div class="form-group">
                        ...
                        value="{{ $edit_advert->email }}" class="form-control" id="" placeholder="Email">
                    </div>
                    @error('email')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                     ...
                     <div class="form-group">
                        ...
                        value="{{ $edit_advert->phone }}" class="form-control" id="" placeholder="Phone">
                    </div>
                    @error('phone')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                    ...
                    <div class="form-group">
                      ...
                      value="{{ $edit_advert->address }}" class="form-control" id="" placeholder="Address">
                  </div>
                  @error('address')
                      <span class="text-danger">{{ $message }}</span>
                  @enderror
                  ...
                  <div class="form-group">
                    ...
                    value="{{ $edit_advert->whatsapp }}" class="form-control" id="" placeholder="Whatsapp Link">
                </div>
                @error('whatsapp')
                    <span class="text-danger">{{ $message }}</span>
                @enderror
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        value="{{ $edit_advert->facebook }}" class="form-control" id="" placeholder="Facebook Link">
                    </div>
                    @error('facebook')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                    ...
                    <!-- /.col -->
                      ...
                      <div class="form-group">
                        ...
                        value="{{ $edit_advert->twitter }}" class="form-control" id="" placeholder="Twitter Link">
                    </div>
                    @error('twitter')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                    ...
                    <div class="form-group">
                        ...
                        value="{{ $edit_advert->linkedin }}" class="form-control" id="" placeholder="Linkedin Link">
                    </div>
                    @error('linkedin')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                    ...
                    <div class="form-group">
                      ...
                      value="{{ $edit_advert->event_date }}" class="form-control" id="" placeholder="Event Date">
                  </div>
                  @error('event_date')
                      <span class="text-danger">{{ $message }}</span>
                  @enderror
                      ...
                      <div class="form-group">
                        <img style="width: 100px; height: 100px;" src="{{ URL::asset("/public/../$edit_advert->images1")}}" alt="">
