        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{ url('admin/createthepartners') }}" method="post" enctype="multipart/form-data">
                  @csrf
                  {{-- @method('PUT') --}}
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <label>Company Name</label>
                          ...
                          value="{{ old('name') }}" class="form-control" id="" placeholder="Company Name">
                      </div>
                      @error('name')
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            value="{{ old('partner_url') }}" class="form-control" id="" placeholder="https://example.com">
                        </div>
                        @error('partner_url')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
