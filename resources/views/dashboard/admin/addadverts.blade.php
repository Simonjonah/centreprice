        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{ url('admin/createadverts') }}" method="post" enctype="multipart/form-data">
                  @csrf
                  {{-- @method('PUT') --}}
                ...
                <div class="card-body">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <label>Company Name</label>
                          ...
                          value="{{ old('company_name') }}" class="form-control" id="" placeholder="Company Name">
                      </div>
                      @error('company_name')
                  ...
                  <div class="form-group">
                    ...
                    value="{{ old('whatsapp') }}" class="form-control" id="" placeholder="Whatsapp Link">
                </div>
                @error('whatsapp')
                    <span class="text-danger">{{ $message }}</span>
                @enderror
{{-- 
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        value="{{ old('facebook') }}" class="form-control" id="" placeholder="Facebook Link">
                    </div>
                    @error('facebook')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                    ...
                    <!-- /.col -->
                      ...
                      <div class="form-group">
                        ...
                        value="{{ old('twitter') }}" class="form-control" id="" placeholder="Twitter Link">
                    </div>
                    @error('twitter')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                    ...
                    <div class="form-group">
                        ...
                        value="{{ old('linkedin') }}" class="form-control" id="" placeholder="Linkedin Link">
                    </div>
                    @error('linkedin')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                    ...
                    <div class="form-group">
                      ...
                      value="{{ old('event_date') }}" class="form-control" id="" placeholder="Event Date">
                  </div>
                  @error('event_date')
                      <span class="text-danger">{{ $message }}</span>
                  @enderror
