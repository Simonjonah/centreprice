          ...
          <div class="col-md-3">
              ...
              <div class="card-body box-profile">
                <div class="text-center">
                  <img style="width: 200px; height: 200px;" class="profile-user-img img-fluid img-circle"
                       src="{{ asset('/public/../'.$view_vendors->images)}}"
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                ...
                <p class="text-muted">{{ $view_vendors->ngstate['state'] }}  {{ $view_vendors->Lga->district['districts'] }} {{ $view_vendors->Lga['lga'] }}</p>
              ...
              <div class="card-body">
                <div class="tab-content">
                  <div class="active tab-pane" id="activity">
                    ...
                    <div class="post">
                      <div class="user-block">
                        ...
                        alt="User profile picture">
                        <span class="username">
                          <a href="#">{{ $view_vendors->name }}</a>
                          <a href="#" class="float-right btn-tool"><i class="fas fa-times"></i></a>
                        </span>
                        <span class="description">{{$view_vendors->created_at->diffForHumans()}}</span>
                      </div>
                      <!-- /.user-block -->
                      <p>
                        {{$view_vendors->address }}
                      </p>
                  ...
                  <div class="tab-pane" id="settings">
                    <form action="{{ url('admin/updatevendor/'.$view_vendors->ref_no3) }}" method="post" enctype="multipart/form-data">
                      @csrf
                  ...
                  @method('PUT')
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" name="fname" value="{{ $view_vendors->fname }}" class="form-control" id="inputName" placeholder="Name">
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" name="lname" value="{{ $view_vendors->lname }}" class="form-control" id="inputName" placeholder="Name">
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="number" name="phone" value="{{ $view_vendors->phone }}" class="form-control" id="inputEmail" placeholder="Phone Number">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputEmail" class="col-sm-2 col-form-label">Email</label>
                        <div class="col-sm-10">
                          <input type="email" name="email" value="{{ $view_vendors->email }}" class="form-control" id="inputEmail" placeholder="Email Number">
                        </div>
                      </div>
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <select name="ngstate_id" class="form-control select2" style="width: 100%;">
                            <option value="{{ $view_vendors->ngstate['id'] }}">{{ $view_vendors->ngstate['state'] }}</option>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input disabled type="text" value="{{ $view_vendors->Lga->district['districts'] }}" class="form-control" id="inputSkills" placeholder="Districts">
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <select name="lga_id" class="form-control select2" style="width: 100%;">
                            <option value="{{ $view_vendors->Lga['id'] }}">{{ $view_vendors->Lga['lga'] }}</option>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <select name="subscription_fee" class="form-control select2" style="width: 100%;">
                            <option value="{{ $view_vendors->subscription_fee }}">{{ $view_vendors->subscription_fee }}</option>
                          </select>
                        </div>
