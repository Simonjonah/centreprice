        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{ url('admin/updateestate/'.$edit_states->id) }}" method="post" enctype="multipart/form-data">
                  @csrf
                @method('PUT')
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    value="{{ $edit_states->state }}" class="form-control" id="" placeholder="Enter State">
                  </div>
                  @error('state')
