          ...
          <div class="col-md-3">
              ...
              <div class="card-body box-profile">
                <div class="text-center">
                  <img style="width: 200px; height: 200px;" class="profile-user-img img-fluid img-circle"
                       src="{{ asset('/public/../'.$edit_franchise->images)}}"
                       alt="User profile picture">
                </div>

                <h3 class="profile-username text-center">{{ $edit_franchise->name }}</h3>

                <p class="text-muted text-center">@if ($edit_franchise->role == '1')
                  Franchise
                @elseif ($edit_franchise->role == '2')
                  Distributor
                @else
                Vendor
                @endif</p>
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                ...
                <p class="text-muted">{{ $edit_franchise->ngstate['state'] }}  {{ $edit_franchise->Lga->district['districts'] }} {{ $edit_franchise->Lga['lga'] }}</p>
                ...
                <div class="tab-content">
                  <div class="active tab-pane" id="activity">
                    ...
                    <div class="post">
                      <div class="user-block">
                        ...
                        alt="User profile picture">
                        <span class="username">
                          <a href="#">{{ $edit_franchise->name }}</a>
                          <a href="#" class="float-right btn-tool"><i class="fas fa-times"></i></a>
                        </span>
                        <span class="description">{{$edit_franchise->created_at->diffForHumans()}}</span>
                      </div>
                      <!-- /.user-block -->
                      <p>
                        <b>Address:</b>
                  ...
                  @method('PUT')
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="number" name="phone" value="{{ $edit_franchise->phone }}" class="form-control" id="inputEmail" placeholder="Phone Number">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputEmail" class="col-sm-2 col-form-label">Email</label>
                        <div class="col-sm-10">
                          <input type="email" name="email" value="{{ $edit_franchise->email }}" class="form-control" id="inputEmail" placeholder="Email Number">
                        </div>
                      </div>
                      <div class="form-group row">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input disabled type="text" value="{{ $edit_franchise->Lga->district['districts'] }}" class="form-control" id="inputSkills" placeholder="Districts">
                        </div>
                      </div>
