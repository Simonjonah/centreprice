          ...
          <div class="col-md-3">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <p class="text-muted text-center">@if (Auth::guard('web')->user()->role == '1')
                  Franchise
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                ...
                <p class="text-muted">{{ Auth::guard('web')->user()->ngstate['state'] }}  {{ Auth::guard('web')->user()->Lga->district['districts'] }} {{ Auth::guard('web')->user()->Lga['lga'] }}</p>
                ...
                @else
                <span class="tag tag-dark">Vendor</span>
                @endif
                </p>
              ...
              <div class="card-body">
                <div class="tab-content">
                  <div class="active tab-pane" id="activity">
                    ...
                    <div class="post">
                      <div class="user-block">
                        ...
                        <span class="description">{{Auth::guard('web')->user()->created_at->diffForHumans()}}</span>
                      </div>
                      <!-- /.user-block -->
                      <p>
                  ...
                  <div class="tab-pane" id="settings">
                    <form action="{{ url('web/updateprofile2/'.Auth::guard('web')->user()->ref_no2) }}" method="post" enctype="multipart/form-data">
                      @csrf
                  ...
                  @method('PUT')
                      ...
                      <div class="form-group row">
                        <label for="inputName" class="col-sm-2 col-form-label">First Name</label>
                        <div class="col-sm-10">
                          <input type="text" name="lname" value="{{ Auth::guard('web')->user()->lname }}" class="form-control" id="inputName" placeholder="Last Name">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputEmail" class="col-sm-2 col-form-label">Phone</label>
                        <div class="col-sm-10">
                          <input type="number" name="phone" value="{{ Auth::guard('web')->user()->phone }}" class="form-control" id="inputEmail" placeholder="Phone Number">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputEmail" class="col-sm-2 col-form-label">Email</label>
                        <div class="col-sm-10">
                          <input type="email" name="email" value="{{ Auth::guard('web')->user()->email }}" class="form-control" id="inputEmail" placeholder="Email Number">
                        </div>
                      </div>
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <select name="ngstate_id" class="form-control select2" style="width: 100%;">
                            <option value="{{ Auth::guard('web')->user()->ngstate['id'] }}">{{ Auth::guard('web')->user()->ngstate['state'] }}</option>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input disabled type="text" value="{{ Auth::guard('web')->user()->Lga->district['districts'] }}" class="form-control" id="inputSkills" placeholder="Districts">
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <select name="lga_id" class="form-control select2" style="width: 100%;">
                            <option value="{{ Auth::guard('web')->user()->Lga['id'] }}">{{ Auth::guard('web')->user()->Lga['lga'] }}</option>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <select name="subscription_fee" class="form-control select2" style="width: 100%;">
                            <option value="{{ Auth::guard('web')->user()->subscription_fee }}">{{ Auth::guard('web')->user()->subscription_fee }}</option>
                          </select>
                        </div>
