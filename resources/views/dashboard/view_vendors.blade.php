                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  @foreach ($view_distributors as $view_distributor)
                    <tr>
                        ...
                        <td><a href="{{ url('web/viewsingledistributorbyfran/'.$view_distributor->ref_no2) }}"
                          class='btn btn-info'>
                        ...
                        <td>@if ($view_distributor->status == null)
                          ...
                          @endif</td>
                        {{-- <td><a href="{{ url('web/approvedistributorbyfran/'.$view_distributor->ref_no) }}"
                       ...
                       <td><a href="{{ url('web/editdistributorbyfran/'.$view_distributor->ref_no) }}"
                        class='btn btn-info'>
                         <i class="far fa-edit"></i>
                     </a></td>
                       
                         
                       <td><a href="{{ url('web/deletedistributorbyfran/'.$view_distributor->ref_no) }}"
