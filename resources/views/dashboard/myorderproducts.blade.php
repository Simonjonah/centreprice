                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  @foreach ($view_orders as $view_order)
                    <tr>
                        ...
                        <td><a href="{{ url('web/viewsingleorder/'.$view_order->ref_no) }}"
                          class='btn btn-info'>
                        ...
                        <td>@if ($view_order->status == null)
                          ...
                          @endif</td>
                        {{-- <td><a href="{{ url('web/deliverorder/'.$view_order->ref_no) }}"
                          class='btn btn-success'>
                           <i class="far fa-user"></i>
                       </a></td> --}}
                       <td><a href="{{ url('web/suspendorder/'.$view_order->ref_no) }}"
                        class='btn btn-warning'>
                         <i class="far fa-bell"></i>
                     </a></td>
                       {{-- <td><a href="{{ url('web/editorder/'.$view_order->ref_no) }}"
                        class='btn btn-info'>
                         <i class="far fa-edit"></i>
                     </a></td> --}}
                       
                         
                       <td><a href="{{ url('web/deleteorder/'.$view_order->ref_no) }}"
