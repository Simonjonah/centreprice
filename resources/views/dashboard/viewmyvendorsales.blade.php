                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  @foreach ($view_purchases as $view_purchase)
                    <tr>
                       ...
                       <td><a href="{{ url('web/productreceived/'.$view_purchase->ref_no) }}"
                        class='btn btn-success'>
                         <i class="far fa-user">Mark Received</i>
                     </a></td>
                     ...
                     <td>@if ($view_purchase->productstatus == 'received')
                      ...
                      <span class="badge badge-dark">Waiting to Ship</span>
                      @elseif ($view_purchase->productstatus == 'shipping')
                      <span class="badge badge-dark">Shipping</span>
                    @endif
                   </td>

                       <td><a href="{{ url('web/deletepurchse/'.$view_purchase->ref_no) }}"
