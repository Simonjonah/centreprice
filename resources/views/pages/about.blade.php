@include('pages.common.header')
                        ...
                        <div class="about-image-gallery">
                            ...
                            <ul class="shape-group">
                                ...
                                <li class="shape-4 scene" data-sal-delay="500" data-sal="fade" data-sal-duration="200">
                                    <img src="{{ asset('front/assets/images/counterup/shape-02.png') }}" alt="Shape">
                                </li>
                            </ul>
                        </div>
                    </div>
        ...
        <section class="why-choose-area-2 section-gap-large">
            <div class="container edublink-animated-shape">
                <div class="section-title section-center" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                    <span class="pre-title" style="color: #000;">Who we are</span>
                    <p style="color: #000;">At CSCC, your success is our priority. We’re here to equip you with the knowledge, resources, and ongoing support you need to build a thriving business and achieve your financial goals.</p>
                </div>
                <div class="row g-5">
            ...
            <ul class="shape-group">
                ...
                <li class="shape-4 scene" data-sal-delay="500" data-sal="fade" data-sal-duration="200">
                    <img data-depth="2" src="{{ asset('front/assets/images/about/shape-40.png') }}" alt="shape">
                </li>
            </ul>
        </section>
        <!-- End Why Choose Area  -->
        ...
        <div class="testimonial-area-5 gap-lg-bottom-equal" style="padding-top: 60px;">
            <div class="container">
