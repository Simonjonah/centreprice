            ...
            <div class="container">
                <div class="breadcrumb-inner">
                    <div class="page-title">
                        <h1 class="title">Root Products</h1>
                    </div>
                    <ul class="edu-breadcrumb">
                        ...
                        <li class="separator"><i class="icon-angle-right"></i></li>
                        <li class="breadcrumb-item active" aria-current="page">Root Products</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="container">
                <div class="edu-sorting-area">
                    <div class="sorting-left">
                        <h6 class="showing-text">We found <span>{{ $view_rootsproductscount }}</span> Products available for you</h6>
                    </div>
                ...
                <div class="row g-5">
                    @foreach ($view_rootsproducts as $view_rootsproduct)
                        @if ($view_rootsproduct->status == 'approved')
                        <div class="col-lg-3 col-md-4 col-sm-6" data-sal-delay="100" data-sal="slide-up" data-sal-duration="800">
                            <div class="edu-product">
                                <div class="inner">
                                    <div class="thumbnail">
                                        <a href="{{ url('products/productdetails/'.$view_rootsproduct->ref_no) }}">
                                            <img style="width: 270px; height: 320px;" src="{{ URL::asset("/public/../$view_rootsproduct->images1")}}" alt="Shop Images">
                                        </a>
                                    ...
                                    <div class="content">
                                        <h6 class="title"><a href="{{ url('products/productdetails/'.$view_rootsproduct->ref_no) }}">{{ $view_rootsproduct->subcategory['subcategory'] }}</a></h6>
                                        
                                        <div class="price">NGN {{ $view_rootsproduct->amount }}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
